...
public class RootMotionControlScript : MonoBehaviour
{
    ...
    void OnAnimatorMove()
    {
        ...
        newRootPosition  = Vector3.LerpUnclamped(rbody.position,  newRootPosition,  rootMovementSpeed);
        newRootRotation  = Quaternion.LerpUnclamped(rbody.rotation, newRootRotation, rootTurnSpeed);
